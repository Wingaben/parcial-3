...
function MiPerfil() {
  ...
  function modificarPerfil() {
    ...
    return (
    <Container>
      <Box sx={{ borderRadius: 2,margin:"auto" ,width: "50vw", marginTop:"20px" , background:"rgba(16, 75, 96, 0.21)" , boxShadow:"0 4px 30px rgba(0, 0, 0, 0.1)" , backdropFilter: "blur(7.3px)" , WebkitBackdropFilter:"blur(7.3px)" , border:"1px solid rgba(16, 75, 96, 0.3)"}}>
        <Stack spacing={3} p={3}>
